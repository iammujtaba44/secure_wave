...
//     label: "Requests admin privileges if needed.",
//     task: (context) {
//       locator.get<DevicePolicyController>().requestAdminPrivilegesIfNeeded().then(
//         (isGranted) {
//           showDialog(
//             context: context,
//             builder: (context) {
...
//                     ? const Text("Admin privileges is granted.")
//                     : const Text("Admin privileges have not been granted.\n"
//                         "Either the user has declined the request or This app is not a Device Policy Controller"),
//                 actions: [
//                   TextButton(
//                     onPressed: () {
//                       Navigator.pop(context);
...
//     label: "Checks if admin privileges are active",
//     task: (context) {
//       locator.get<DevicePolicyController>().isAdminActive().then((isAdmin) {
//         showDialog(
//           context: context,
//           builder: (context) {
//             return AlertDialog(
...
//     label: "Locks the app in kiosk mode",
//     task: (_) {
//       locator.get<DevicePolicyController>().lockApp();
//     },
//   ),
//   TaskAction(
//     label: "Unlocks the app",
//     task: (_) {
//       locator.get<DevicePolicyController>().unlockApp();
//     },
//   ),
//   TaskAction(
//     label: toggleScreenAwakeLabel,
//     task: (_) async {
//       await locator
//           .get<DevicePolicyController>()
//           .setKeepScreenAwake(!(await locator.get<DevicePolicyController>().isScreenAwake()));
//     },
//   ),
//   TaskAction(
//     label: "Gets device information",
//     task: (context) {
//       locator.get<DevicePolicyController>().getDeviceInfo().then((Map<String, dynamic>? info) {
//         showDialog(
//           context: context,
//           builder: (context) {
//             return AlertDialog(
...
//               child: const Text('Disable'),
//               onPressed: () {
//                 locator.get<DevicePolicyController>().setAsLauncher(enable: false);
//                 Navigator.pop(context);
//               },
//             ),
//             TextButton(
//               child: const Text('Enable'),
//               onPressed: () {
//                 locator.get<DevicePolicyController>().setAsLauncher(enable: true);
//                 Navigator.pop(context);
//               },
//             ),
//           ],
...
//   TaskAction(
//     label: "Clear Device Owner App",
//     task: (_) => locator.get<DevicePolicyController>().clearDeviceOwnerApp(),
//   ),
//   TaskAction(
//     label: "Set Camera",
//     task: (context) {
...
//               child: const Text('Disable'),
//               onPressed: () {
//                 locator.get<DevicePolicyController>().setCameraDisabled(disabled: true);
//                 Navigator.pop(context);
//               },
//             ),
//             TextButton(
//               child: const Text('Enable'),
//               onPressed: () {
//                 locator.get<DevicePolicyController>().setCameraDisabled(disabled: false);
//                 Navigator.pop(context);
//               },
//             ),
//           ],
...
//               child: const Text('Disable'),
//               onPressed: () {
//                 locator.get<DevicePolicyController>().setScreenCaptureDisabled(disabled: true);
//                 Navigator.pop(context);
//               },
//             ),
//             TextButton(
//               child: const Text('Enable'),
//               onPressed: () {
//                 locator.get<DevicePolicyController>().setScreenCaptureDisabled(disabled: false);
//                 Navigator.pop(context);
//               },
//             ),
//           ],
...
//               child: const Text('Disable'),
//               onPressed: () {
//                 locator.get<DevicePolicyController>().setKeyguardDisabled(disabled: true);
//                 Navigator.pop(context);
//               },
//             ),
//             TextButton(
//               child: const Text('Enable'),
//               onPressed: () {
//                 locator.get<DevicePolicyController>().setKeyguardDisabled(disabled: false);
//                 Navigator.pop(context);
//               },
//             ),
//           ],
...
//               TextButton(
//                 onPressed: () {
//                   locator.get<DevicePolicyController>().wipeData();
//                   Navigator.pop(context);
//                 },
//                 child: const Text(
//                   'Wipe',
